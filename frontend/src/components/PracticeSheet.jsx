...
const PracticeSheet = ({ problems, solvedProblems = [], onProblemSolved }) => {
    ...
    return (
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 text-center shadow-3xs">
        <p className="text-slate-500 dark:text-slate-400 text-xs">
          No practice problems generated yet. Refresh or ensure you have selected studied topics in onboarding!
        </p>
      </div>
    );
  }
